...
export class SoSearchComponent implements OnInit, OnDestroy {
  searchFieldData = [];
  searchType = '';
  searchLabel = '';
            ...
            if (result.result) {
              ...
              for (const listElement of this.searchFieldData) {
                ...
                for (const lovItem of data) {
                  ...
                  // for customer site values
                  // if (listElement.lovType === 'soCustomerSite') {
                  //   if (!this.customerSiteArray.includes(lovItem.customerSiteId)) {
                  //     this.customerSiteArray.push(lovItem.customerSiteId);
                  //     listElement.list.push({
                  //       label: lovItem.customerSiteName,
                  //       value: String(lovItem.customerSiteId)
                  //     });
                  //   } else { }
                  // }
